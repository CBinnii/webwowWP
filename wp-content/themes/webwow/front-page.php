...
<html lang="en">
	...
	<body>
		<main>
			...
			<h2>Wij werken momenteel aan een fantastische nieuwe website. <br /> Nog heel even geduld. Contact? Mail naar:</h2>
			<a href="mailto:info@webwow.nl">info@webwow.nl</a>
		</main>
		<footer>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-webwow.png" alt="Logo Webwow">
		</footer>
	</body>
</html>